...
- [ ] Endure Detention or Escape
	- [ ] Face Professor [[2-World/People/Staff/Silverquill/Fain\|Fain's]]  interrogation
	- [ ] Serve detention or slip away unnoticed
	- [ ] Gather clues about the Wintergeist

- [ ] Confront the Spirit’s Power
	- [ ] Return to the Hunting Grounds at night 
	- [ ] Battle the Wintergeist in its empowered form 
	- [ ] Survive long enough to flee or regroup

- [ ] Seek Shelter in the Forest
	- [ ] Meet Vormor, Warden of the Oak Tree 
	- [ ] Rest, recover, and gain his guidance 
	- [ ] Learn about the Frozen Mound 

- [ ] Unseal the Frozen Mound 
	- [ ] Locate the Wintergeist’s lair 
	- [ ] Solve the magical rune puzzle 
	- [ ] Enter the ancient chamber 

- [ ] Defeat the Star-Blessed Wintergeist 
	- [ ] Battle the Spirit in its lair 
	- [ ] Rescue any missing students 
	- [ ] Recover the Star of Remembrance 

- [ ] Return the Star to Neverwood Academy 
	- [ ] Ride the magical sleigh back to the Feasthall 
