...
- [x] ~~Learn more about mimics and their behaviours~~
### Creatures Acting Wrong
- [x] ~~Investigate the giant frogs near campus~~
- [x] ~~Identify unusual aggression and mutation in local wildlife~~
- [x] ~~Compare findings to known magical physiology cases~~
### A Student in the Shadows
- [x] ~~Learn more about the unnamed student mentioned by staff~~
	- [x] ~~Speak with faculty and students~~
	- [x] ~~Piece together rumours and fragmented accounts~~
- [x] ~~Determine whether the student is connected to recent घटनाएँ
### The Murgaxor Records
- [x] ~~Find Murgaxor’s student records~~
	- [x] ~~Ask the staff about the Admin Office~~
	- [x] ~~Enquire about where student records are kept~~
	- [x] ~~Retrieve Murgaxor’s records from the Records Room~~
- [x] ~~Review her academic history and disciplinary actions~~
### A Family of Interest
- [x] ~~Learn about the Murgaxor family~~
- [x] ~~Uncover references to Grenshel Murgaxor~~
- [x] ~~Identify Daniel Murgaxor and his connection~~
- [x] ~~Recognise a pattern of dangerous magical research~~
### Elemental & Arcane Instability
- [x] ~~Contain the steam mephits~~
...
- [ ] Identify that the substance is consistent across घटनाएँ
...
- [ ] Track the source of the घटनाएँ
