...
* [x] ~~Receive [[2-World/People/Staff/Taiva Loreweaver\|Taiva Loreweaver]]’s instructions to investigate and contain the breach~~

### Climbing the Beanstalk
* [x] Ascend the towering beanstalk into the sky
* [x] Avoid hazards along the stalk and keep an eye out for magical phenomena
* [x] Reach the floating realm created by the Bag of Beans
