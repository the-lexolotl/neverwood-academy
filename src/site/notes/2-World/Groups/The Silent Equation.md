...
> [!column|no-i no-t]
>> [!note|no-title]
>> ![The Silent Equation 1.png](/img/user/z_Assets/The%20Silent%20Equation%201.png)
>
>> [!note|div-m] file.name
>> ~~~meta-bind
>> INPUT[select(
>> option(1, ℹ️General),
>> option(2, ⁉️Goals),
