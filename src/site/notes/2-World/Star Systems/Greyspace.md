...
> **Notable Features:** | A rare geocentric crystal sphere where all bodies—including the sun—orbit [[2-World/Planets/Oerth\|Oerth]]; star-gem constellations embedded in the crystal shell |
...
# Star System Details
## [[2-World/Planets/Oerth\|Oerth]] (Primary)
At the centre of Greyspace lies [[2-World/Planets/Oerth\|Oerth]], the system primary. All other celestial bodies orbit this world, making it both physically and culturally the heart of the sphere.
[[2-World/Planets/Oerth\|Oerth]] is the most populated and influential world in the system, and the origin point for most spelljamming activity.

## Kule (Celene)
One of [[2-World/Planets/Oerth\|Oerth]]’s moons, Kule is a barren, tidally locked earth body with no atmosphere. It is often associated with elven influence and ancient secrets.

## Raenei (Luna)
The second moon of [[2-World/Planets/Oerth\|Oerth]], Raenei is larger and more varied than Kule. It plays a significant role in navigation and celestial cycles.

## Liga (The Sun)
Liga is the system’s sun—but crucially, it orbits [[2-World/Planets/Oerth\|Oerth]] rather than the reverse.
...
It completes its orbit in approximately one [[2-World/Planets/Oerth\|Oerth]] year (364 days), defining the system’s seasonal cycle.

## The Grinder
A vast asteroid field orbiting [[2-World/Planets/Oerth\|Oerth]], the Grinder is composed of countless bodies of varying size and composition. It is a major hazard to navigation and a haven for pirates and hidden outposts.
...
A flatworld—a rarity even in wildspace—the Spectre defies conventional planetary structure and lies in the outer reaches of the system.

## Additional Astronomical Features
### The Sisters
A cluster of star-like objects that appear as a single star from [[2-World/Planets/Oerth\|Oerth]]. They generate a dead-magic zone and are known to displace travellers through space and time.
...
# The Crystal Sphere
Greyspace’s crystal shell is vast and visually distinctive, often described as resembling an immense iridescent pearl when viewed from the phlogiston.
The “stars” visible from [[2-World/Planets/Oerth\|Oerth]] are not distant suns, but enormous gemstones embedded within the inner surface of the sphere, emitting a steady, cold light.
...
# History
Greyspace’s unusual structure has profoundly influenced the cosmology of [[2-World/Planets/Oerth\|Oerth]]’s inhabitants. Many cultures believe their world to be at the center of the universe—a rare case where belief aligns with reality.
The system has long served as a hub for spelljamming activity, with trade, exploration, and conflict centred around [[2-World/Planets/Oerth\|Oerth]] and its orbital bodies.
