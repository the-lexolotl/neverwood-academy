...
> ---|---|
> **Primary Bodies:** | Oerth (system primary), Kule, Raenei, Liga (the Sun), The Grinder, Edill, Gnibile, Conatha, Ginsel, Borka, Greela, The Spectre | 
...
> **Notable Features:** | A rare geocentric crystal sphere where all bodies—including the sun—orbit Oerth; star-gem constellations embedded in the crystal shell |
...
## Kule (Celene)
One of Oerth’s moons, Kule is a barren, tidally locked earth body with no atmosphere. It is often associated with elven influence and ancient secrets.
...
## Liga (The Sun)
Liga is the system’s sun—but crucially, it orbits Oerth rather than the reverse.
...
It completes its orbit in approximately one Oerth year (364 days), defining the system’s seasonal cycle.
...
The “stars” visible from Oerth are not distant suns, but enormous gemstones embedded within the inner surface of the sphere, emitting a steady, cold light.
...
# History
Greyspace’s unusual structure has profoundly influenced the cosmology of Oerth’s inhabitants. Many cultures believe their world to be at the center of the universe—a rare case where belief aligns with reality.
