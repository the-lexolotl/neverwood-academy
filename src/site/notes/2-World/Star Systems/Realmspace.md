...
> **Inhabitants:** | Humans and other mortals (primarily on [[2-World/Planets/Toril\|Toril]]), dragons (notably on Coliar), lizardfolk of Karpri, spacefaring peoples, and various extraplanar visitors |
...
# Description
Realmspace is the term used to describe the Torilian system and its surrounding environs within the [[2-World/Realms/Prime Material plane\|Prime Material Plane]]. To those on the surface of [[2-World/Planets/Toril\|Toril]], Realmspace was called the Sea of Night, while the Netherese referred to it as the Skyward Realms. Contained within a crystal sphere suspended in the enormous expanse of the phlogiston, Realmspace consisted of wildspace (empty vacuum), a sun, eight planets and their satellites, and a variety of asteroids, comets, and nebulae.
...
It was believed that the creator races from [[2-World/Planets/Toril\|Toril]] were the earliest intelligent inhabitants of Realmspace, and the first to develop the magical means necessary to travel to other crystal spheres and other planes, around the same time when inhabitants of other spheres also started to travel. These early migrations into Realmspace dated from the apex of the draconic domain over [[2-World/Planets/Toril\|Toril]]. The first to arrive were dwarves, followed by treants, elves, and, lastly, mind flayers.
