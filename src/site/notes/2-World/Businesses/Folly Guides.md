...
## Growth & Reputation (1490–1507 DR)
Folly Guides grew modestly but steadily, hiring scribes, cartographers, and field correspondents to verify details and expand coverage. Contributors included sailors, adventurers, merchants, and retired mercenaries — anyone with firsthand experience.

The company’s reputation was built on reliability, practicality, and editorial independence. Cities and nobles occasionally protested unflattering portrayals, but Tolan refused to compromise the guides’ honesty.
...
| ----------------------------------------------------------------------- | ------ | ----- | ------ | ------- |
| [[2-World/People/Other/Whalebucks/Tolan Whalewake\|Tolan Whalewake]] | Male   | Human | Author | None    |

{ .block-language-dataview}

# Services
Folly Guides produces accessible, reliable travel resources with a focus on honesty and usefulness.

## Core Publications
### Regional Guides
- Comprehensive guides for regions of [[2-World/Planets/Toril\|Toril]]
- Includes maps, roads, hazards, customs, and lodging
- Advice tailored to both travellers and adventurers

### City & Location Guides
- Single-city or single-dungeon guides
- Highlights useful inns, taverns, shops, and guilds
- Lists common cons, scams, and local laws

## Specialised Editions
### Adventurer’s Cut
- Estimates of encounter frequency
- Guidance on dangerous dungeons and wilderness hazards
- Information on resurrection access, local spell restrictions, and mercenary services

### Academic & Institutional Editions
- Expanded historical and cultural context
- Notes on planar phenomena
- Often used by institutions like [[2-World/Hubs/Neverwood Academy\|Neverwood Academy]]

## Bespoke & Commissioned Guides
