---
{"tags":["Category/Realm"],"obsidianUIMode":"preview","MyContainer":null,"image":"Pasted image 20260506233658.png","dg-publish":true,"dg-show-local-graph":true,"dg-show-inline-title":true,"dg-show-backlinks":true,"dg-path":"World/Realms/Pocket Dimensions.md","permalink":"/world/realms/pocket-dimensions/","dgShowBacklinks":true,"dgShowLocalGraph":true,"dgShowInlineTitle":true,"dgPassFrontmatter":true,"dg-note-properties":{"tags":["Category/Realm"],"obsidianUIMode":"preview","MyContainer":null,"image":"Pasted image 20260506233658.png"}}
---

> [!infobox|left]+
> # Pocket Dimensions
> ![Pasted image 20260506233658.png](/img/user/z_Assets/Pasted%20image%2020260506233658.png)
> ###### General Information
> Stat  |  Value |
> ---|---|
...
> **Connections & Influence:** | Linked to the [[2-World/Realms/Astral Plane\|Astral Plane]], conjuration magic, extradimensional containers |
...
Because they exist partially outside conventional reality, pocket dimensions frequently interact with the [[2-World/Realms/Astral Plane\|Astral Plane]], and unstable dimensions can rupture or collapse if damaged.
...
## Planar Adjacency
Pocket dimensions typically exist adjacent to the [[2-World/Realms/Astral Plane\|Astral Plane]], though some are linked to other planes depending upon their creator and purpose.
...
Interactions between extradimensional objects can be extremely dangerous. Placing a **Bag of Holding** inside another extradimensional space, such as a **Portable Hole**, can create catastrophic planar ruptures connected to the [[2-World/Realms/Astral Plane\|Astral Plane]].
...
Pocket dimensions can collapse if their magical structure fails, potentially ejecting occupants into the [[2-World/Realms/Astral Plane\|Astral Plane]] or trapping them between planes entirely.
